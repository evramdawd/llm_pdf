...
// Props: List of Chats and Active Chat ID
type Props = {
  chats: DrizzleChat[],
  chatId: number
}
    ...
    <div className="flex flex-col gap-2 mt-4">
      {chats.map((chat) => (
        <Link key={chat.id} href={`/chat/${chat.id}`}>
          {/* cn function from Shad in utils -- Make the active chat in sidebar = blue w white text, otherwise make the text white when hovering over */}
          <div className={
